...
public class FormPrincipal extends javax.swing.JFrame {
    ...
    private void btnPesquisaArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisaArquivoActionPerformed
        String filePath = FileSelector.getFilePath();
        boletimGenerator.setFilePath(filePath);
        txtCaminhoBoletim.setText(filePath);

    }//GEN-LAST:event_btnPesquisaArquivoActionPerformed
